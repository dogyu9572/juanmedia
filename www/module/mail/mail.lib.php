...
########################################### 인포뱅크 문자 발송 ED ###################################################
########################################### 문자박사 문자 발송 ST ###################################################
function munja_send($mtype, $name, $phone, $msg, $callback="010-9213-0647", $contents="", $reserve="", $reserve_time="", $etc1="", $etc2="") {
	$host = "www.munja123.com";
	$id = "oneullab"; // 문자박사 아이디 입력
	$pass = "dhsmffoq2388!!"; // 문자박사 비밀번호 입력
	$param = "remote_id=".$id;
