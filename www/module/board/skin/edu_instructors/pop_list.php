                ...
                <dl>
                    ...
                    <dd><select name="category" class="text" onchange="document.form1.submit()" style="width:120px;">
                            ...
                            for($i=0; $i < $arrCategory1["total"]; $i++){
                                if($arrCategory1["list"][$i]['cat_no']==$_GET['category']){
                                    $tnSelect[$i] = "selected";
                                }
                                echo "<option value=\"".$arrCategory1["list"][$i]['cat_no']."\" ".$tnSelect[$i].">".$arrCategory1["list"][$i]['cat_name']."</option>";
                            }
                            ?>
                        </select></dd>
                </dl>
                    ...
                    if($arrBoardList["list"]["total"] > 0){
                        for($i=0; $i < $arrBoardList["list"]["total"]; $i++){
                            ...
                            <tr data-order="<?=$arrBoardList['list'][$i]['idx']?>">
                                ...
                                <td style="width:5%;"><?=$categoryString?></td>
                                ...
                                <td style="width:5%;"><img src="<?=$imgsrc[$i]?>" style="max-width:100px;padding:5px;"></td>
                                <td style="width:10%;">
                                    <div class="btns">
