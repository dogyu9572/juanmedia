...
<div class="container">
	...
	<div class="title"><?=$arrEvaluationInfo["list"][0]["subject"]?> > <?=$arrBoardInfo["list"][0]["boardname"]?></div>
		...
		<dl>
			...
			<dd>
				<select name="etc_3" id="etc_3">
					<option value="">전체</option>
					<?php foreach($arrEtc3 as $key=> $val){?>
					<option value="<?=$key?>" <?=$_GET["etc_3"] == $key?"selected":""?>><?=$val?></option>
					<?php } ?>
				</select>
			</dd>
		</dl>
		...
		<dl class="search_wrap">
			...
			<dd>
				<select name="sw" style="width:120px;">
					...
					<option value='s'<?=$_GET['sw']=="s"?" selected='selected'":""?>>항목명</option>
	...
	<div class="inbox">
		<div class="tab_div">
			<div class="tab_menu <?=$_GET['etc_3']?"":"on"?>" onclick="location.href='/backoffice/module/board/board_view.php?boardid=sub_evaluation&category=<?=$_GET['category']?>'">전체</div>
			<div class="tab_menu <?=$_GET['etc_3']=="1"?"on":""?> " onclick="location.href='/backoffice/module/board/board_view.php?boardid=sub_evaluation&category=<?=$_GET['category']?>&etc_3=1'">일반</div>
			<div class="tab_menu <?=$_GET['etc_3']=="2"?"on":""?> " onclick="location.href='/backoffice/module/board/board_view.php?boardid=sub_evaluation&category=<?=$_GET['category']?>&etc_3=2'">최종 선정자 확인</div>
		</div>
		<div class="bdr_top">
			<div class="left">
				...
				<table>
					...
					?>
						<tr data-order="<?=$arrBoardList['list'][$i]['idx']?>">
							...
							<td style="width:15%;"><?=$arrEtc3[$arrBoardList["list"][$i]['etc_3']]?></td>
							...
							<td style="width:15%;"><?=$arrBoardList["list"][$i]['etc_2']?></td>
							<td style="width:15%;"><?=$arrBoardList["list"][$i]['b_sort']?></td>	
