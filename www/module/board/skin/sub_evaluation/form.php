	...
	<div class="inbox write_tbl mo_break_write">
		...
		<table>
			...
			<tr>
				<th>타입</th>
				<td><div class="inputs">
					<label class="radio"><input type="radio" name="etc_3" value="1" <?if($arrBoardArticle["list"][0]['etc_3']!="2"){echo " checked";}?>><i></i>일반</label>
					<label class="radio"><input type="radio" name="etc_3" value="2" <?if($arrBoardArticle["list"][0]['etc_3']=="2"){echo " checked";}?>><i></i>최종 선정자 확인</label> 
				</div></td>
			</tr>
			...
			<tr>
				<th>순서</th>
				<td><div class="inputs"><input type="text" class="w2" style="text-align:right;" name="b_sort" maxlength="100" value="<?=$arrBoardArticle["list"][0]['b_sort']?$arrBoardArticle["list"][0]['b_sort']:"0"?>"><p> # 순서가 낮을수록 먼저 표시됩니다.</p></div></td>
			</tr>
			<tr style="display:none;">
				<th>날짜</th>
