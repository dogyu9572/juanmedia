                ...
                <dl class="search_wrap">
                    ...
                    <dd>
                        <select name="reception_status" class="text" onchange="document.form1.submit()" style="width:120px;">
                            ...
                            <option value="종료" <?= $_GET['reception_status']
                            == "종료" ? "selected" : "" ?>>종료</option>
                        </select>
                    </dd>
                </dl>
               <!-- <dl class="search_wrap">
                    <dt>등록일</dt>
                    <dd>
                        <input type="text" class="datepicker" name="sdate" value="<?php /*=$_GET['sdate']*/?>" autocomplete="off"/><em>~</em><input type="text" class="datepicker" name="edate" value="<?php /*=$_GET['edate']*/?>" autocomplete="off"/>
                    ...
                    if($arrBoardList["list"]["total"] > 0){
                        for($i=0; $i < $arrBoardList["list"]["total"]; $i++){
                            ...
                            <tr data-order="<?=$arrBoardList['list'][$i]['idx']?>">
                                ...
                                <td style="width:10%;"><?=$arrBoardList["list"][$i]['category1']?></td>
                                <td style="width:10%;"><?=$arrBoardList["list"][$i]['category2']?></td>
                                ...
                                <td style="width:10%;"><?=number_format($arrBoardList["list"][$i]['quantity'])?></td>
                                <td style="width:10%;"><?=$arrBoardList["list"][$i]['b_sort']?></td>
                                <td><?=date("Y-m-d", strtotime($arrBoardList["list"][$i]['wdate']))?></td>
                                <td style="width:10%;">
                                    <div class="btns">
                                        <a href="javascript:void(0);" onclick="fnAddMsds('<?=$arrBoardList['list'][$i]['idx']?>')" class="btn perf">선택</a>
                                    </div>
                                </td>
                            </tr>
                            <?
