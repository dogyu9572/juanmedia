    ...
    <script type="text/javascript">
        ...
        function fnCopyEst(eidx){
            if(confirm("복사 하시겠습니까?")) {
                location.href = "/module/board/equ_copy.php?idx="+eidx;
            }
        }
        //-->
    </script>
...
<!--                        <th><label class="check notxt"><input type="checkbox" name="" id="allCheck"><i></i></label></th>-->
                        ...
                        <th class="pc_vw">이용등급</th>
                        <th class="pc_vw">총 장비수</th>
                        <th class="pc_vw">순번</th>
                        <th class="pc_vw">등록일</th>
                        <th class="pc_vw">확인</th>
                    </tr>
                    </thead>
                    <tbody id="sortWrap">
                    <?
...
<!--                                <td style="width:5%;"><label class="check notxt"><input type="checkbox" value="--><?php //=$arrBoardList["list"][$i]['idx']?><!--" name="chk_list"><i></i></label></td>-->
                                ...
                                <td style="width:10%;"><?=$arrBoardList["list"][$i]['equ_number']?></td>
                                <td style="width:10%;"><?=$arrBoardList["list"][$i]['subject']?></td>
                                <td style="width:10%;"><?=number_format($arrBoardList["list"][$i]['fee'])?></td>
                                <td style="width:10%;"><?=$arrBoardList["list"][$i]['usage_level']?></td>
                                <td style="width:10%;">
                                    <?= ($arrBoardList["list"][$i]['stock_quantity'] == 0 && $arrBoardList["list"][$i]['stock'] === 'Y') ? '' : number_format($arrBoardList["list"][$i]['stock_quantity']) ?>
                                </td>
                                <td style="width:10%;"><?=$arrBoardList["list"][$i]['b_sort']?></td>
                                <td><?=date("Y-m-d", strtotime($arrBoardList["list"][$i]['wdate']))?></td>
                                <td>
                                    <div class="btns">
                                        <a href="<?=$_SERVER["PHP_SELF"]?>?boardid=<?=$arrBoardInfo["list"][0]["boardid"]?>&mode=view&idx=<?=$arrBoardList["list"][$i]['idx']?>&category=<?=$_GET['category']?>" class="btn modi">확인</a>
                                    </div>
                                </td>
                            </tr>
                            <?
        ...
        <div class="bdr_btm">
           ...
           <!-- <div class="btns">
                ...
                <a href="<?php /*=$_SERVER["PHP_SELF"]*/?>?boardid=<?php /*=$arrBoardInfo["list"][0]["boardid"]*/?>&mode=write&category=<?php /*=$_GET['category']*/?>" class="btn">신규등록</a>
            </div>-->
        </div>
    </div>
    </div>
...
//체크박스
    ...
    $arrCategoryInfo = getCategoryInfo(mysqli_real_escape_string($GLOBALS['dblink'], 35));
    ...
    ?>
    <!-- pageTitle -->
    <div class="pageTitle inner">장비대여신청</div>
    <!-- //pageTitle -->
    ...
    <div class="tabType1">
        <ul class="inner">
            ...
            for($i=0; $i<$arrCategory1["total"]; $i++):
                ...
                ?>
                <li <?=$activeClass?>><a href="/equ/list.php?cat_no=<?=$arrCategory1["list"][$i]['cat_no']?>"><?=$arrCategory1["list"][$i]['cat_name']?></a></li>
            <?php endfor; ?>
        </ul>
    </div>
    <!-- //tabType1 -->
                            ...
                            <li class="eq <?=$soldOut?>">
                                <a href="<?=$href?>">
                                    ...
                                    <div class="box">
                                        ...
                                        <div class="txt">
                                            <span>대여료</span>
                                            <em><?=number_format($arrBoardList["list"][$i]['fee'])?>원(1일)</em>
                                        </div>
                                    </div>
                                </a>
                            </li>
