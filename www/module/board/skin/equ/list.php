				...
				<table>
					...
					<thead>
						<tr>	
                            ...
                            <th class="pc_vw">재고수량</th>
                            <th class="pc_vw">순번</th>
                            <th class="pc_vw">등록일</th>
                            <th class="pc_vw">대여이력</th>
					...
					?>
                            <tr data-order="<?=$arrBoardList['list'][$i]['idx']?>">
                                ...
                                <td>
                                    <div class="btns">
                                        <a href="<?=$_SERVER["PHP_SELF"]?>?boardid=equ_applicants&sw=all&sk=&page_size=10&equ_idx=<?=$arrBoardList["list"][$i]['idx']?>" class="btn modi" style="width:70px">대여이력</a>
                                    </div>
                                </td>
                                <td>
                                    <div class="btns">
