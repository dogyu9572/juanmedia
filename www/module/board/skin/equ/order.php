        ...
        <div class="inner">
            ...
            <div class="orderSide">
                            ...
                            <div class="right">
                                <div class="baseSel">
                                    <select id="discountSelect" name="discount" onchange="calculateDiscount()">
                                        <option value="">선택</option>
                                        <?php
                                        echo "echo:"; print_r($arrDiscountInfo['list'][0][$name]); echo "<br>" ;
                                        $discounts = [
                                            '장기대여' => 'equ_discount1',
                                            '휴관일' => 'equ_discount2',
                                            '토요일' => 'equ_discount3',
                ...
                <div class="payWrap">
                    ...
                    <a href="javascript:void(0);" class="btnType1" onclick="document.getElementById('enrollmentForm').submit();">대여 신청</a>
                </div>
                <!-- //payWrap -->
            </div>
            <!-- //orderSide -->
