...
<div class="container">
	...
	<div class="inbox write_tbl mo_break_write">
		...
		<table>
			...
			<tr>
				<th>등록일</th>
				<td><div class="inputs"><input type="datetime-local" class="w4" name="wdate" value="<?=$arrBoardArticle["list"][0]['wdate'] != ""?stripslashes($arrBoardArticle["list"][0]['wdate']):date("Y-m-d H:i:s")?>"></div></td>
			</tr>
			<tr>
				<th>사용여부</th>
				<td><div class="inputs">
