		...
		<dl class="search_wrap">
			...
			<dd>	
				<select name="sw">
					...
					<option value='s'<?=$_GET['sw']=="s"?" selected='selected'":""?>>구절</option>
				</select>	
				...
				<table>
					...
					?>
						<tr>
							...
							<td><i class="mo_vw">내용</i><?=$arrBoardList["list"][$i]['contents']?></td>
							<td><i class="mo_vw">구절</i><?=$arrBoardList["list"][$i]['subject']?></td>
...
<?}else{###################################################### 사용자 페이지 ######################################################?>
	<div class="tit-box">
		<h3 class="tit-bullet heading1">원목실</h3>
		<p class="sub">치료하는 병원, 교육하는 병원, 선교하는 병원 고신대복음병원의 태동</p>
	</div>
	<div class="tab-wrap">
		<div class="tab">
			<a href="/depart/depart_41.php" class="btn">원목실 소개</a>
			<a href="/depart/depart_42.php" class="btn">예배안내</a>
			<a href="/depart/depart_43.php" class="btn">원목실 소식</a>
			<a href="javascript:void(0);" class="btn active">오늘의 말씀</a>
			<a href="/depart/depart_45.php" class="btn">팀솔데</a>
			<a href="/depart/depart_46.php" class="btn">자원봉사자</a>
		</div>
	</div>
	<div class="section">
		<?
		...
		<div class="today-word">
			<p class="bible"><?=$arrBoardList["list"][$i]['subject']?></p>
			<p class="cont"><?=$arrBoardList["list"][$i]['contents']?></p>
			<p class="date"><?=date("Y.m.d",strtotime($arrBoardList["list"][$i]['wdate']))?></p>
		</div>
		<?php
			}
		}
