		...
		<dl class="search_wrap">
			...
			<dd>
				<select name="sw" style="width:120px;">
					<option value='s'<?=$_GET['sw']=="all"?" selected='selected'":""?>>메뉴명</option>
				</select>	
				...
				<table>
					...
					<thead>
						<tr>	
							...
							<th class="pc_vw">아이콘</th>
							<th class="pc_vw">메뉴명</th>
					...
					?>
						<tr data-order="<?=$arrBoardList['list'][$i]['idx']?>">
							...
							<td><img src="<?=$imgsrc[$i]?>" style="max-width:100%;"></td>	
							...
							<td style="width:5%;"><?=$arrBoardList["list"][$i]['homepage']?></td>
							<td style="width:5%;"><?=$arrBoardList["list"][$i]['b_sort']?></td>
