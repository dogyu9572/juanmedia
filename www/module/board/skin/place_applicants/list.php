                ...
                <dl class="search_wrap">
                    ...
                    <dd>
                        <select name="sw" style="width:120px;">
                            ...
                            <option value='s'<?=$_GET['sw']=="s"?" selected='selected'":""?>>공간명</option>
                    ...
                    if($arrBoardList["list"]["total"] > 0){
                        for($i=0; $i < $arrBoardList["list"]["total"]; $i++){
                            ...
                            <tr data-order="<?=$arrBoardList['list'][$i]['idx']?>">
                                ...
                                <td style="width:10%;"><?=$arrBoardList["list"][$i]['app_no']?></td>
                                <td style="width:10%;"><?=$arrBoardList["list"][$i]['name']?></td>
                                ...
                                <td style="width:5%;"><?=$arrBoardList["list"][$i]['rental_date']?></td>
                                <td style="width:5%;"><?=$arrBoardList["list"][$i]['rental_start_time']?> ~ <?=$arrBoardList["list"][$i]['rental_end_time']?></td>
                                <td style="width:40%;"><?=date("Y-m-d",strtotime($arrBoardList["list"][$i]['wdate']))?></td>
                                <td style="width:5%;"><?=$arrBoardList["list"][$i]['rental_type']?></td>
                                <td style="width:10%;"><?=$arrBoardList["list"][$i]['status']?></td>
...
<!--                    <option value='all'--><?php //=$_GET['sw']=="all"?" selected='selected'":""?><!-->선택</option>-->
    ...
    <script type="text/javascript">
        function fnPrint(boardid, idx) {
            window.open('/module/board/print_place.php?boardid=' + boardid + '&idx=' + idx);
        }
        //<![CDATA[
        $(document).ready(function(){
//달력
