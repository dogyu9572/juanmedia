...
function fnPrint(boardid, idx) {
    window.open('/module/board/print_edu.php?boardid=' + boardid + '&idx=' + idx);
}
				...
				<table>
					...
					<thead>
						<tr>	
							...
							<th class="pc_vw">생년월일</th>
							<th class="pc_vw">교육구분</th>
					...
					?>
						<tr data-order="<?=$arrBoardList['list'][$i]['idx']?>">
                            ...
                            <td style="width:5%;"><?=sprintf("%02d", $arrBoardList["list"][$i]['edu_no'])?></td>
                            ...
                            <td style="width:5%;"><?=$arrBoardList["list"][$i]['birthdate']?></td>
                            <td style="width:40%;"><?=getCategoryName($arrBoardList["list"][$i]['category1']);?>/<?=getCategoryName($arrBoardList["list"][$i]['category2']);?></td>
							...
							<td style="width:15%;" title="<?=$arrBoardList["list"][$i]['contents']?>"><?=$arrBoardList["list"][$i]['contents']?></td>
                            <td style="width:10%;">
                                <div class="btns">
