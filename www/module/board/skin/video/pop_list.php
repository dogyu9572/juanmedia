            ...
            <div class="bdr_list tac">
                <table>
                    ...
                    <tr>
                        ...
                        <th class="pc_vw">상영회명</th>
                        <th class="pc_vw">접수기간</th>
                        <th class="pc_vw">상영일</th>
                    ...
                    if($arrBoardList["list"]["total"] > 0){
                        for($i=0; $i < $arrBoardList["list"]["total"]; $i++){
                            ...
                            <tr data-order="<?=$arrBoardList['list'][$i]['idx']?>">
                                ...
                                <td style="width:5%;"><?=$arrBoardList["list"][$i]['reception_status']?></td>
                                <td>
                                    <div title="<?=$subject_title?>">
                                        <?=$arrBoardList["list"][$i]['subject']?>
                                    </div>
                                </td>
                                <td><?=$arrBoardList["list"][$i]['r_start_date']?> ~ <?=$arrBoardList["list"][$i]['r_end_date']?></td>
                                <td><?=$arrBoardList["list"][$i]['screening_date']?></td>
