...
$category = $_REQUEST['mode']=="modify"?$arrBoardArticle["list"][0]["category"]:$_GET["category"];
...
<div class="container">
	...
	<div class="title"><?=$arrCategory[$category]?> <?=$inputText?></div>
	...
	<div class="inbox write_tbl mo_break_write">
		...
		<input type="hidden" name="returnURL" value="<?=$_SERVER["PHP_SELF"]?>?boardid=<?=$arrBoardInfo["list"][0]["boardid"]?>&category=<?=$category?>">
		...
		<div class="tit"><?=$arrCategory[$category]?> 정보 <i>*</i></div>
		<table>
