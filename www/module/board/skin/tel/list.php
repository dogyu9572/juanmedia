		...
		<dl class="search_wrap">
			...
			<dd>
				<select name="sw">
					...
					<option value='s'<?=$_GET['sw']=="s"?" selected='selected'":""?>>부서명</option>
					<option value='e1'<?=$_GET['sw']=="e1"?" selected='selected'":""?>>전화번호</option>
				</select>	
				...
				<table>
					...
					?>
						<tr>
							...
							<td><i class="mo_vw">부서명</i><?=$arrBoardList["list"][$i]['subject']?></td>
							<td><i class="mo_vw">전화번호</i><?=$arrBoardList["list"][$i]['etc_1']?></td>
