	...
	<div class="inbox write_tbl mo_break_write">
		...
		<table>
			...
			<tr>
				<th>모집여부</th>
				<td><div class="inputs">
					<label class="radio"><input type="radio" name="is_notice" value="Y" <?if($arrBoardArticle["list"][0]['no']!="1"){echo " checked";}?>><i></i>모집중</label> 
					<label class="radio"><input type="radio" name="is_notice" value="" <?if($arrBoardArticle["list"][0]['no']=="1"){echo " checked";}?>><i></i>마감</label>
					<em></em>
				</div></td>
			</tr>
			<tr>
