				...
				<table>
					...
					?>
						<tr>
							...
							<td><i class="mo_vw">No.</i><?=$categoryTitle?></td>
							<td><i class="mo_vw">모집여부</i><?=$arrBoardList["list"][$i]['no']=="0"?"모집중":$categoryTitle?></td>
...
?>
	<div class="tit-box">
			<h3 class="tit-bullet heading1">채용공고</h3>
			<p class="sub">고신대학교복음병원의 미래를 함께 할 창의적이고 역량있는 인재를 모집합니다.</p>
		</div>
			...
			<div class="brd-list">
				...
				<div class="body">
					...
					if($arrBoardList["list"]["total"] > 0){
						for($i=0; $i < $arrBoardList["list"]["total"]; $i++){
							//순번 & 공지 & 신규표시
							$listNum = '<span class="tag gray">마감</span>';
							//공지
							if($arrBoardList["list"][$i]['no']=="0"){
								$categoryTitle = 'class="notice"';
								$listNum = '<span class="tag secondary">모집중</span>';
							}					
					...
					?>
					<!-- <a href="/service/service_3_view.php" class="row file">
						<p class="no"><span class="tag secondary">모집중</span></p>
						<p class="tit">게시글 제목입니다. 게시글 제목입니다.게시글 제목입니다.게시글 제목입니다.게시글 제목입니다.게시글 제목입니다.</p>
					</a>
					<a href="/service/service_3_view.php" class="row file">
						<p class="no"><span class="tag secondary">모집중</span></p>
						<p class="tit">게시글 제목입니다. 게시글 제목입니다.게시글 제목입니다.게시글 제목입니다.게시글 제목입니다.게시글 제목입니다.</p>
					</a>
					<a href="/service/service_3_view.php" class="row">
						<p class="no"><span class="tag secondary">모집중</span></p>
						<p class="tit">게시글 제목입니다. 게시글 제목입니다.게시글 제목입니다.게시글 제목입니다.게시글 제목입니다.게시글 제목입니다.</p>
					</a>
					<a href="/service/service_3_view.php" class="row file">
						<p class="no"><span class="tag gray">마감</span></p>
						<p class="tit">게시글 제목입니다. 게시글 제목입니다.게시글 제목입니다.</p>
					</a>
					<a href="/service/service_3_view.php" class="row">
						<p class="no"><span class="tag gray">마감</span></p>
						<p class="tit">게시글 제목입니다. 게시글 제목입니다.게시글 제목입니다.</p>
