	...
	<div class="inbox write_tbl mo_break_write">
		...
		<table>
			...
			<tr>
				...
				<td>
					...
					<select name="etc_1" id="etc_1">
						...
						?>
						<option value="<?=$key?>" <?=$key == $arrBoardArticle["list"][0]["etc_1"]?"selected":""?>><?=$val?></option>
						<?php
						}
						?>
					</select>
			...
			<tr>
				<th>영문 진료과 설명</th>
				<td>
					<textarea id="etc_3" name="etc_3" cols="100" rows="10"><?=stripslashes($arrBoardArticle["list"][0]['etc_3'])?></textarea>
					<?
					$CKContent = "etc_3";
					include $_SERVER['DOCUMENT_ROOT'] . "/ckeditor/Editor.php";
					?>
			...
			<tr>
				<th>운영 클리닉</th>
				<td>
					<textarea id="etc_5" name="contents" cols="100"><?=stripslashes($arrBoardArticle["list"][0]['etc_5'])?></textarea>
					쉼표(,)로 구분
					<?
					//$CKContent = "contents";
					//include $_SERVER['DOCUMENT_ROOT'] . "/ckeditor/Editor.php";
			...
			<tr>
				<th>영문 운영 클리닉</th>
				<td>
					<textarea id="etc_4" name="contents" cols="100"><?=stripslashes($arrBoardArticle["list"][0]['etc_4'])?></textarea>
					쉼표(,)로 구분
					<?
					//$CKContent = "contents";
					//include $_SERVER['DOCUMENT_ROOT'] . "/ckeditor/Editor.php";
