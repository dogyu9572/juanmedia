...
<div class="container">
	...
	<div class="inbox top_search">
		...
		<dl>
			<dt>예정일</dt>
			<dd><input class="datepicker" type="text" name="scdate" value="<?=$_GET["scdate"]?>" autocomplete="off" /><em>~</em><input class="datepicker" type="text" name="ecdate" value="<?=$_GET["ecdate"]?>"  autocomplete="off" /></dd>
		</dl>
				...
				<table>
					...
					<thead>
						<tr>	
							...
							<th class="pc_vw">예정일</th>
							<th class="pc_vw">오전</th>
							<th class="pc_vw">오후</th>
					...
					?>
						<tr>
							...
							<td><i class="mo_vw">예정일</i><?=$arrBoardList["list"][$i]['schedule_date']?></td>
							<td><i class="mo_vw">오전</i><?=$arrBoardList["list"][$i]['etc_1'] == "Y"?"O":"X"?></td>
							<td><i class="mo_vw">오후</i><?=$arrBoardList["list"][$i]['etc_2'] == "Y"?"O":"X"?></td>
							<td><i class="mo_vw">오후</i><?=$arrBoardList["list"][$i]['contents']?></td>
