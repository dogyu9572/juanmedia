...
<div class="container">
	...
	<div class="inbox write_tbl mo_break_write">
		...
		<input type="hidden" name="category" value="<?=$_REQUEST['mode']=="modify"?$arrBoardArticle["list"][0]["category"]:$_GET['category']?>">
		...
		<table>
			...
			<tr>
				<th>예정일</th>
				<td><input type="text" class="w3 datepicker" name="schedule_date" value="<?=$arrBoardArticle["list"][0]['schedule_date']??date("Y-m-d")?>" maxlength="10" /></td>
			</tr>
			<tr style="display:none;">
				<th>공지</th>
				<td><div class="inputs">
			...
			<tr>
				<th>오전</th>
				<td><div class="inputs"><label class="check"><input type="checkbox" class="check" name="etc_1" value="Y" <?=$arrBoardArticle["list"][0]['etc_1'] == "Y"?"checked":""?>><i></i>오전휴무</label></div></td>
			</tr>
			<tr>
				<th>오후</th>
				<td><div class="inputs"><label class="check"><input type="checkbox" class="check" name="etc_2" value="Y" <?=$arrBoardArticle["list"][0]['etc_2'] == "Y"?"checked":""?>><i></i>오후휴무</label></div></td>
			</tr>
			<tr>
				<th>내용</th>
				<td>
					<textarea id="contents" name="contents" cols="100" rows="10"><?=stripslashes($arrBoardArticle["list"][0]['contents'])?></textarea>
					<?
					//$CKContent = "contents";
			...
			<tr>
				<th>영문 내용</th>
				<td>
					<textarea id="etc_5" name="etc_5" cols="100" rows="10"><?=stripslashes($arrBoardArticle["list"][0]['etc_5'])?></textarea>
					<?
					//$CKContent = "contents";
					//include $_SERVER['DOCUMENT_ROOT'] . "/ckeditor/Editor.php";
					?>
