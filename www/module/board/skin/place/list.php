...
function fnCopyEst(eidx){
    if(confirm("복사 하시겠습니까?")) {
        location.href = "/module/board/place_copy.php?idx="+eidx;
    }
}
//-->
</script>
            ...
            <dd id="cat_02">
                <select name="cat2" id="cat2" class="text" onchange="fnCat2(this.value);" style="width:120px;">
                    ...
                    for($i=0;$i<$arrCategory2["total"];$i++){
                        ...
                        */?>
                        <option value="<?php /*=$arrCategory2["list"][$i]['cat_no']*/?>"<?php /*=$arrCatCode[3]==$arrCategory2["list"][$i]['cat_no']?" selected":""*/?>><?php /*=$arrCategory2["list"][$i]['cat_name']*/?></option>
                    <?/*}*/?>
                </select>
            </dd>
        </dl>-->
				...
				<table>
					...
					?>
                        <tr data-order="<?=$arrBoardList['list'][$i]['idx']?>">
                            ...
                            <td style="width:10%;"><?=$arrBoardList["list"][$i]['etc_1'] == 'Y' ? '노출' : '비노출'?></td>
                ...
                <div class="rightForm">
                    <div class="baseSel">
                        <select name="sw" id="sw" class="text">
                            ...
                            <option value="s" <?=$_GET["sw"] == "s"?"selected":""?>>공간명</option>
                    ...
                    <li>
                        <a href="<?=$_SERVER["PHP_SELF"]?>?boardid=<?=$arrBoardInfo["list"][0]["boardid"]?>&mode=view&idx=<?=$arrBoardList["list"][$i]['idx']?>">
                            ...
                            <div class="box">
                                ...
                                <div class="txt">
                                    <span>대관료</span>
                                    <em><?=number_format($arrBoardList["list"][$i]['fee'])?>(1시간)</em>
                                </div>
                            </div>
                        </a>
                    </li>
