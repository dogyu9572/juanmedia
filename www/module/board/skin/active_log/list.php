...
?>
<div class="tit-box">
	<h3 class="tit-bullet heading1">활동내역</h3>
	<p class="sub">예수 그리스도의 사랑에 근거한 의료 복음 전파</p>
</div>
<div class="tab-wrap">
	<div class="tab">
		<a href="/depart/depart_61.php" class="btn">장기려기념의료선교센터</a>
		<a href="javascript:void(0);" class="btn active">활동내역</a>
		<a href="/depart/depart_63.php" class="btn">사진첩</a>
	</div>
			</div>
