...
$arrInfo = getCouponInfo(mysqli_real_escape_string($GLOBALS['dblink'], $_REQUEST['couponidx']));
$relidxs = $arrInfo['list'][0]['shopGoodIdx'];
...
$updateQuery = "update tbl_coupon set shopGoodIdx='".$relidxs."' where idx=".$arrInfo['list'][0]['idx'];
