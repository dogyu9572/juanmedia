...
function inPrice(){
	...
	document.getElementById("coupon_check1").checked = false;
	document.getElementById("coupon_check2").checked = false;
}
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td><input type="radio" id="coupon_check1" name="coupon_check" value="true" onclick="setPrice('<?=$arrCouponList["list"][$i]['idx']?>|<?=$couponprice?>')"></td>
						</tr>
						<?	
							}
						}?>
						...
						<tr>
							...
							<td><input type="radio" id="coupon_check2" name="coupon_check" value="true" onclick="setPrice('<?=$arrCouponList1["list"][$i]['idx']?>|<?=$couponprice?>')"></td>
						</tr>
						<?	
								}
							}
