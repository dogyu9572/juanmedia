...
if($_REQUEST['idx']){
	...
	$arrInfo = getGoodInfoGcode(mysqli_real_escape_string($GLOBALS['dblink'], $_REQUEST['g_code']));
}
...
$arrQna = getBoardListBase("qna", mysqli_real_escape_string($GLOBALS['dblink'], $_REQUEST['idx']), "", "", 0, 0);
$arrAfter = getBoardListBase("after", "", "e1", mysqli_real_escape_string($GLOBALS['dblink'], $_REQUEST['idx']), 0, 0);
	...
	<div id="sub_container">
		<div class="content">
			...
			<div id="rightArea">
				...
				<!-- 내용 : s -->
					<div class="location">
						<p class="local"><span class="home"></span><span class="current"><?=$arrAllCategory[$arrCatCode[0]]?></span></p>
					</div>
					<!-- //location -->
					...
					<div class="productRead">
								...
								<table>					
									...
									<tbody>
										...
										<tr>
											...
											<td class="lineTop">
												<select id="opt_contents_<?=$i?>" name="opt_contents_<?=$i?>" onchange="setAddOpt(<?=$arrInfo["list"][0]['price']?>, this.value);">
										...
										<tr>
											<td colspan="2">
												...
												<!-- <div class="choose">
													<p class="name">1.0 tog / 블루</p>
													<div class="quantity">
														<p class="num"><input type="text" id="" name="" value=""  /></p>
														<div class="control">
															<a href="#" class="btn_white">+</a>
															<a href="#" class="btn_white">-</a>
														</div>
													</div>
										...
										<tr>
											<td colspan="2" class="lineTop">
												<div class="choose">
													<p class="name">수량</p>
													<div class="quantity">
														<p class="num"><input type="text" id="qty" name="qty" value="1"  /></p>
														<div class="control">
						...
						<div class="productTabs" id="detail01">
							<ul>
								...
								<li><a href="#detail02">상품평 (<span class="num"><?=count($arrAfter["list"]["total"])?></span>)</a></li>
								<li><a href="#detail03">상품 Q&A (<span class="num"><?=count($arrQna["list"]["total"])?></span>)</a></li>
						...
						<div class="productTabsDetail">
							...
							<div class="productTabs" id="detail02">
								<ul>
									...
									<li class="on"><a href="#detail02">상품평 (<span class="num"><?=count($arrAfter["list"]["total"])?></span>)</a></li>
									<li><a href="#detail03">상품 Q&A (<span class="num"><?=count($arrQna["list"]["total"])?></span>)</a></li>
									<li><a href="#detail04">배송ㆍ반품 / 상품고시</a></li>
								</ul>
							</div>
							...
							<!-- 상품평 -->
							<div class="detail">
								<iframe id='Iframe1' src='/module/shop/good_review.php?idx=<?=$arrInfo["list"][0]["idx"]?>' width='100%' height='100' frameborder='0' marginheight='0' marginwidth='0' scrolling="no"></iframe>
							</div>
							<!-- //상품평 -->
							...
							<div class="productTabs" id="detail03">
								<ul>
									<li class="first"><a href="#detail01">상세정보</a></li>
									<li><a href="#detail02">상품평 (<span class="num"><?=count($arrAfter["list"]["total"])?></span>)</a></li>
									<li class="on"><a href="#detail03">상품 Q&A (<span class="num"><?=count($arrQna["list"]["total"])?></span>)</a></li>
									<li><a href="#detail04">배송ㆍ반품 / 상품고시</a></li>
								</ul>
							</div>
							<!-- //tabs --> 
							<!-- 상품 Q&A -->
							<div class="detail">	
								<iframe id='Iframe2' src='/module/shop/qna_iframe.php?category=<?=$arrInfo["list"][0]["idx"]?>' width='100%' height='100' frameborder='0' marginheight='0' marginwidth='0' scrolling="no"></iframe>
							</div>
							<!-- //상품 Q&A -->
...
resize_frame('Iframe1');
resize_frame('Iframe2');
</script>
