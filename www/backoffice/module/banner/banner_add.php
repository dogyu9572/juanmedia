...
<div class="container">
	...
	<div class="inbox write_tbl mo_break_write">
		...
		<table>
			...
			<tr>
				<th>제목</th>
				<td><div class="inputs"><input type="text" class="w4" name="b_subject" maxlength="100">
				<!-- &nbsp;<input type="text" class="w2 picker" name="b_color_1" maxlength="10" value="#000000"> -->
				</div></td>
			</tr>			
			<tr style="display:none;">
				<th>텍스트1</th>
				<td><div class="inputs"><input type="text" class="w4" name="b_contents" maxlength="100">
				&nbsp;<input type="text" class="w2 picker" name="b_color_2" maxlength="10" value="#000000">
				</div></td>
			</tr>
			<tr style="display:none;">
				<th>텍스트2</th>
				<td><div class="inputs"><input type="text" class="w4" name="b_etc_1" maxlength="100">
				&nbsp;<input type="text" class="w2 picker" name="b_color_3" maxlength="10" value="#000000">
				
				</div></td>
			</tr>
			<tr style="display:none;">
				<th>텍스트3</th>
				<td><div class="inputs"><input type="text" class="w4" name="b_etc_2" maxlength="100">
				&nbsp;<input type="text" class="w2 picker" name="b_color_4" maxlength="10" value="#000000">				
				</div></td>
			</tr>
			<tr style="display:none;">
			<th>텍스트 배치</th>
				<td><div class="inputs">
					<label class="radio"><input type="radio" name="b_brand" value="1" checked><i></i>상</label>
					<label class="radio"><input type="radio" name="b_brand" value="2"><i></i>중</label> 
					<label class="radio"><input type="radio" name="b_brand" value="3"><i></i>하</label> 
					<label class="radio"><input type="radio" name="b_brand" value="4"><i></i>사용안함</label> 
					<em></em>
				</div></td>
			</tr>			
			<tr>
			...
			<tr>
				<th>링크</th>
				<td><div class="inputs"><input type="text" class="w4" name="b_url" maxlength="250" value=""></div></td>
			</tr>
			<tr>
				<th>링크설정</th>
				<td><div class="inputs">
					<label class="radio"><input type="radio" name="b_target" value="_blank" ><i></i>_blank (새창)</label>
					<label class="radio"><input type="radio" name="b_target" value="_self" checked><i></i>_self (현재페이지)</label> 
