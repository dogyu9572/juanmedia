...
// 통계 데이터 가져오기
$statistics = getMediaStatistics($year);
    ...
    <div class="container">
        ...
        <div class="inbox">
            ...
            <div class="bdr_top">
                ...
                <div class="bdr_right">
                    <div class="btns">
                        <a href="/backoffice/module/board/board_statistic_media_xls.php?year=<?=$year?>" class="excel" download>엑셀파일로 저장<span class="pc_vw"></span></a>
                    </div>
                </div>
            </div>
