...
$filename = $_SITE['NAME'] . "_공간신청내역_" . date('mdHi') . ".xls";
...
for ($i = 0; $i < $arrList["total"]; $i++) {
    ...
    <tr>
        ...
        <td>" . htmlspecialchars($arrList["list"][$i]['rental_date'], ENT_QUOTES, 'UTF-8') . "</td>
        <td>" . htmlspecialchars($arrList["list"][$i]['rental_start_time'], ENT_QUOTES, 'UTF-8') . " ~ " . htmlspecialchars($arrList["list"][$i]['rental_end_time'], ENT_QUOTES, 'UTF-8') . "</td>
