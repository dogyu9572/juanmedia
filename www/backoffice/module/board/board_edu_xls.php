...
for ($i = 0; $i < $arrList["total"]; $i++) {
    ...
    <tr>
        ...
        <td>" . htmlspecialchars(getCategoryName($arrList["list"][$i]['category2']), ENT_QUOTES, 'UTF-8') . "</td>
        <td>" . htmlspecialchars($arrList["list"][$i]['subject'], ENT_QUOTES, 'UTF-8') . "</td>
        <td>" . htmlspecialchars($arrList["list"][$i]['e_start_date'], ENT_QUOTES, 'UTF-8') . " ~ " . htmlspecialchars($arrList["list"][$i]['e_end_date'], ENT_QUOTES, 'UTF-8') . "</td>
        ...
        <td>" . htmlspecialchars($arrList["list"][$i]['fee'], ENT_QUOTES, 'UTF-8') . "원</td>
