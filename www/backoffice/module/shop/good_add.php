		...
		<table class="admin-table-type1">
		  ...
		  <tbody>
			...
			<tr>
				<th>상품명</th>
				<td class="space-left">
					<label><input type="radio" name="g_name" value="성인" checked>성인</label>&nbsp;&nbsp;
				<label><input type="radio" name="g_name" value="청소년">청소년</label>&nbsp;&nbsp;
				<label><input type="radio" name="g_name" value="어린이">어린이</label>&nbsp;&nbsp;
				<label><input type="radio" name="g_name" value="경로">경로</label>
				</td>
			</tr>
			<tr style="display:none;">
				<th>상품명_영문</th>
				<td class="space-left"><input type="text" name="model" style="width:90%" class="input" maxlength="200" /></td>
			</tr>
			<tr>
				<th>정렬순서</th>
			...
			<tr style="display:none;">
				<th>회원등급별 노출여부</th>
				<td class="space-left">
					<label><input type="checkbox" name="madein" value="T" checked><font color=blue>일반회원</font></label> &nbsp;
					<label><input type="checkbox" name="vendor" value="T" checked><font color=blue>VIP회원</font></label> &nbsp;
					<label><input type="checkbox" name="brand" value="T" checked><font color=blue>임직원</font></label> &nbsp;
				</td>
			</tr>			
		  </tbody>
		</table>
		...
		*/
		...
		<table class="admin-table-type1">
		  ...
		  <tbody>			
			<tr style="display:none;">
				<th>배송료</th>
				<td class="space-left"><input type="text" name="shipping_charge" style="width:200" maxlength="20" class="input" value="0" /> (숫자만 입력) 0은 배송비 포함 / 3묶음 배송비</td>
			</tr>
			<tr style="display:none;">
				<th>적립금(%)</th>
				<td class="space-left"><input type="text" name="percent_point" style="width:200" maxlength="20" class="input" value="0" /> (숫자와.만 입력)</td>
			</tr>							
			<tr>
				<th style="color:red;">주말</th>
				<td class="space-left"><input type="text" name="p_price" style="width:200" maxlength="20" class="input" value="0"/> (숫자만 입력)</td>
			</tr>
			<tr>
				<th>평일</th>
				<td class="space-left"><input type="text" name="price" style="width:200" maxlength="20" class="input" value="0"/> (숫자만 입력)</td>
			</tr>
			<tr style="display:none;" >
				<th style="color:red;">단체-주말</th>
				<td class="space-left"><input type="text" name="sale_price" style="width:200" maxlength="20" class="input" value="0"/> (숫자만 입력)</td>
			</tr>	
			
			<tr style="display:none;">
				<th>단체-평일</th>
				<td class="space-left"><input type="text" name="vip_price" style="width:200" maxlength="20" class="input" value="0"/> (숫자만 입력)</td>
			</tr>
			
			
			<input type="hidden" name="point" value="0" />
			<input type="hidden" name="point_unit" value="F" />
			<!-- <tr>
				<th>적립금</th>
			...
			<tr>
				<th>상품노출</th>
				<td class="space-left"><input type="radio" id="is_show_y" name="is_show" value="Y" checked><label for="is_show_y"><font color=blue>노출함</font></label>
				<input type="radio" id="is_show_n" name="is_show" value="N"><label for="is_show_n"><font color=red>노출안함</font></label>
				</td>
			</tr>
			<tr style="display:none;">
				<th>리스트옵션</th>
				<td class="space-left">
				<input type="checkbox" id="main_show" name="main_show" value="Y"><label for="main_show"><font color=blue>HIT</font></label> &nbsp;
				<input type="checkbox" id="brand_show" name="brand_show" value="Y"><label for="brand_show"><font color=#400080>인기</font></label> &nbsp;
				<input type="checkbox" id="special_show" name="special_show" value="Y"><label for="special_show"><font color=green>NEW</font></label> &nbsp;
				<input type="checkbox" id="best_show" name="best_show" value="Y"><label for="best_show"><font color=red>추천</font></label> &nbsp;
				</td>
			</tr>
			<tr style="display:none;">
				<th>재고관리</th>
				...
				<table class="admin-table-type1" id="layerStock" style="position:relative; display:none; width:200px !important;">
					<tr>
						<th>재고량</th>
						<td class="space-left"><input type="text" name="stock" style="width:100" maxlength="10" class="input" value="0"/></td>
					</tr>
				</table>
				</td>
			</tr>
		...
		<!-- 개별 재고관리 -->
		<table class="admin-table-type1" id="layerOption1" style="position:relative; display:none;">
		  <colgroup>
		  <col width="140" />
		  <col width="*" />
		  </colgroup>
		...
		<h3 class="admin-title-middle" style="display:none;">상품 사진 | <input type="radio" id="image_type_1" name="image_type" value="1" checked onclick="checkImageType(1);"><label for="image_type_1"><font color=blue>대표이미지</font></label>  <!--<input type="radio" id="image_type_2" name="image_type" value="2" onclick="checkImageType(2);"><label for="image_type_2"><font color=green>개별이미지</font></label> --></h3>
		<!-- 이미지 타입 1 -->
		<div id="layerImage1" style="position:relative; display:none;">
		...
		<h3 class="admin-title-middle" style="display:none;">상품 설명</h3>
		<table width="100%;" border="0" cellspacing="1" cellpadding="6" bgcolor="#dedede" style="display:none;">
		  <colgroup>
		  <col width="140" />
		  <col width="*" />
		  </colgroup>
		  <tbody>
			<tr>
				...
				<textarea id="contents" name="memo"></textarea>
