...
//상품 리스트
$subQuery = " AND A.stock_type in (2,3) ";
				...
				<table>
					...
					<thead>
						<tr>							
							...
							<th class="pc_vw">완료일
							<a href="javascript:void(0);" onclick="fnOrderby('sell_date','desc')">▼</a><a href="javascript:void(0);" onclick="fnOrderby('sell_date','asc')">▲</a></th>
					...
					if($arrList['list']['total'] > 0){
						for ($i=0;$i<$arrList['list']['total'];$i++){
							...
							if($arrList['list'][$i]['stock_type']=="1"){								
								...
								$arrList['list'][$i]['stock_type_txt'] = "판매완료";
								$sell_date = substr($arrList['list'][$i]['sell_date'],0,10);
								$saleState = "saled";
								...
								$saleState = "";
								$sell_date = substr($arrList['list'][$i]['trust_date'],0,10);
							}
							############################################ 판매상태 ######################################## ED
					?>
						<tr>
							...
							<td><i class="mo_vw">완료일</i><?=$sell_date?></td>
							<td><?=$simg?></td>
...
<!-- 							<td><i class="mo_vw">소비자가</i><?=number_format($arrList['list'][$i]['p_price'])?></td> -->
							...
							<td><i class="mo_vw">실결제 금액</i><?=number_format($arrList['list'][$i]['s_pay'])?></td>
