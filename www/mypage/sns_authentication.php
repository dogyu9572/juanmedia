...
<div class="container sub" id="container">
    ...
    <div class="subSec pt80 last">
        <div class="mySide inner">
            ...
            <div class="rightCont">
				<div class="bigTit">SNS인증</div>

				<div class="withdrawal">
					<div class="tit">회원 비밀번호 확인</div>
					<p>회원님의 정보를 안전하게 보호하기 위해 SNS 인증을 진행합니다.</p>
					<div class="inputs">
						<button class="btn_sns">SNS 인증하기</button>
					</div>

					<div class="btnCenter two mini">
						<a href="javascript:void(0);" class="btnType1 black">확인</a>
					</div>
				</div>
            </div>
        </div>
