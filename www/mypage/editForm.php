						...
						<div class="joinWrap edit">
							...
							<div class="formJoin">
								...
								<div class="line">
									...
									<div class="right">
										<div class="baseInput">
											<input type="password" name="user_pw2" id="user_pw2" placeholder="비밀번호를 다시 입력해주세요.">
										</div>
									</div>
								</div>
								<div class="line">
...
<script type="text/javascript">
    ...
    function checkForm(frm){
        if(frm.user_pw.value != ""){
            if (!validatePassword(frm.user_pw.value)){
                alert("비밀번호는 8~12자의 영문 대소문자, 숫자, 특수문자 조합으로 입력해 주세요.");
                frm.user_pw.focus();
                return false;
            }else if (frm.user_pw2.value==""){
                alert("비밀번호 확인을 입력해 주세요.");
                frm.user_pw2.focus();
                return false;
            }else if (frm.user_pw.value != frm.user_pw2.value){
