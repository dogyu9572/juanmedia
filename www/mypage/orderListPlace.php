                        ...
                        <div class="rightForm">
                            <div class="baseSel">
                                <select name="sw">
                                    ...
                                    <option value="subject" <?=$_GET["sw"] == "s"?"selected":""?>>공간명</option>
                                ...
                                if($arrBoardList["list"]["total"] > 0){
                                    for($i=0; $i < $arrBoardList["list"]["total"]; $i++){
                                        ...
                                        <tr data-order="<?=$arrBoardList['list'][$i]['idx']?>">
                                            ...
                                            <td><?=$arrBoardList["list"][$i]['rental_start_time']?> ~<br /><?=$arrBoardList["list"][$i]['rental_end_time']?></td>
											<td><?=$arrBoardList["list"][$i]['usage_people']?></td>
                                            <td><?=$arrBoardList["list"][$i]['subject']?></td>
											<td><?= number_format($arrBoardList["list"][$i]['finalamount']) ?></td>
                                            ...
                                            <td><?=$arrBoardList["list"][$i]['status'];?></td>                                                    <td>
                                                <a href="detailPlace.php?idx=<?=$arrBoardList["list"][$i]['idx'];?>" class="btnTypeSm">상세보기</a>
                                            </td>
                                        </tr>
                                        <?
                                    }
