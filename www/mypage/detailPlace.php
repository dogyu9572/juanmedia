...
$arrBoardPlaceArticle = getBoardArticleView("equ", $_GET["category"], $arrBoardArticle["list"][0]["place_idx"],"read");
$imgsrc = "/uploaded/board/equ/".$arrBoardPlaceArticle["files"][0]['re_name'];
                            ...
                            <div class="simpleBox">
                                ...
                                <div class="textWrap">
                                    ...
                                    <div class="info">
                                        ...
                                        <div class="txt"><?=$arrBoardPlaceArticle["list"][0]["rental_date"]?></div>
                                    </div>
                                    <div class="info">
                                    ...
                                    <div class="info">
                                        ...
                                        <div class="txt"><?=number_format($arrBoardPlaceArticle["list"][0]['fee'])?>원</div>
                                    </div>
                                </div>
                            </div>
                        </div>
